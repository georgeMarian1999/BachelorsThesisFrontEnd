...
export const ColaborariRefuzateProfesor = (props) =>{
    ...
    const getCrtUserCol= () =>{
        ...
        var config = {
            method: 'get',
            url: 'http://licenta.com/colaborare/refuzate/profesor/'+JSON.parse(sessionStorage.getItem("loggeduser")).id,
            headers: {
            }
        };
